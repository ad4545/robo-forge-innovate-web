  ...
  const products = [
    {
      ...
      icon: <Box className="h-10 w-10 text-robotics-purple" />,
      specs: [
    ...
    },
    {
      ...
      icon: <Activity className="h-10 w-10 text-robotics-purple" />,
      specs: [
    ...
    },
    {
      ...
      icon: <Settings className="h-10 w-10 text-robotics-purple" />,
      specs: [
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Cutting-Edge <span className="text-robotics-purple">Robotics Solutions</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {products.map((product) => (
            ...
            >
              ...
              <p className="text-robotics-gray mb-6">{product.description}</p>
              
              <div className="space-y-3 mb-8">
                {product.specs.map((spec, index) => (
                  <div key={index} className="flex justify-between text-sm">
                    <span className="text-robotics-gray">{spec.label}</span>
                    <span className="text-robotics-purple-light font-medium">{spec.value}</span>
                  </div>
                ))}
              </div>
              
              <Button variant="ghost" className="w-full justify-between text-robotics-purple hover:bg-robotics-purple/10">
